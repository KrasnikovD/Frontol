...
function init() {
    ...
    SRV_LINK = "XXX.XXX.XXX.XXX:XXXXX";
    CARD_FOUND = false;
    SET_TIME_WAIT = "5";
    ERROR_CONNECT = true;
...
// }
/////////////////////////////////////////////////////////////////
//В зависимости отклассификатора устанавливается оптовая цена ///
/////////////////////////////////////////////////////////////////
...
function SetMinPrice() {
    ...
    FD = frontol.currentDocument;
    summBonusAdd = 0; //Cумма бонусов к зачислению
    summPotratsAdd = 0; //Cумма потрат к зачислению
    SummPromo = 0; //Сумма акционного товара
    SummOpt = 0;
    SummChek = 0; // Сумма чека
    SummPositionDiscountOff = 0; //Сумма позиций без дисконта
...
function SetBonusPaymend() {
    MaxPercentSale = 1; //Максимальнй процент списания бонусов 100%
